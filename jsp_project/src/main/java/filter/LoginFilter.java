...
@WebFilter(filterName="LoginFilter", urlPatterns="/15FilterListener/03_LoginFilter.jsp")
		...
		if(method.equals("POST")) {
			...
			if (memberDTO.getId() != null) {
				...
				if(backUrl!=null && !backUrl.equals("")) {					
					...
					resp.sendRedirect("../15FilterListener/03_LoginFilter.jsp");
				}
			}
			else {
				req.setAttribute("LoginErrMsg", "로그인에 실패했습니다.");
				req.getRequestDispatcher("../15FilterListener/03_LoginFilter.jsp")
					.forward(req, resp);
			}
		}
